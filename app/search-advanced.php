...
<head>
  ...
  <title>Search (Advanced) - MSU Dataset Search, Montana State University (MSU) Library</title>
  <meta name="description" content="Advanced search of curated datasets in MSU Dataset Search holdings from creators affiliated with Montana State University."/>
...
<body>
  ...
  <h1 class="offscreen" property="name">Search (Advanced) - Dataset Search, Montana State University (MSU)</h1>
  </header>
  ...
  <nav aria-label="breadcrumb" class="breadcrumb">
    <ol>
      ...
      <li><a href="search-advanced.php">Search (Advanced)</a></li>
    </ol>
  </nav>
  <main role="main" class="column--two-left">
    <section class="details" role="complementary">
    <h2 id="content">Search</h2>
    <form action="search-advanced.php" class="search-form" id="search-form" method="GET" role="search">
      <div>
      <label class="offscreen" for="q">Keyword</label>
      ...
      <input class="text" type="search" id="q" name="q" maxlength="75" autofocus placeholder="Enter keyword..."/>
      </div>
      <div>
      <label class="offscreen" for="creator">Creator</label>
      <svg aria-hidden="true" class="search-icon" width="18" height="18" viewBox="0 0 18 18"><path d="M18 16.5l-5.14-5.18h-.35a7 7 0 10-1.19 1.19v.35L16.5 18l1.5-1.5zM12 7A5 5 0 112 7a5 5 0 0110 0z"></path></svg>
      <input class="text" type="search" id="creator" name="creator" maxlength="75" placeholder="Enter creator..." />
      </div>
      <div>      
      <label class="offscreen" for="title">Title</label>
      <svg aria-hidden="true" class="search-icon" width="18" height="18" viewBox="0 0 18 18"><path d="M18 16.5l-5.14-5.18h-.35a7 7 0 10-1.19 1.19v.35L16.5 18l1.5-1.5zM12 7A5 5 0 112 7a5 5 0 0110 0z"></path></svg>
      <input class="text" type="search" id="title" name="title" maxlength="75" placeholder="Enter title..." />
      </div>
      <input class="button" type="submit" value="AdvancedSearch" />                
    </form>
<!--
<form class="search" action="search.php" method="get" role="search">
<fieldset id="searchForm">
<p><label for="keyword"><strong>Keyword:</strong></label>&nbsp; <input class="text" type="text" id="keyword" name="keyword" maxlength="100" size="100" /></p>
<p><label for="creator"><strong>Creator:</strong></label> <input class="text" type="text" id="creator" name="creator" maxlength="75" size="45" /></p>
<p><label for="title"><strong>Title:</strong></label> <input class="text" type="text" id="title" name="title" maxlength="200" size="200" /></p>
<input type="submit" id="submit" class="button" value="Search" />
</fieldset>
</form>
-->
    <p class="center"><a href="search.php">Back to simple search</a></p>
    </section>
 ...
 */
                ...
                if ($bValidationFailure) {
                        ...
                        */
                        ...
                        echo "<p><a href=\"#search-form\">Use the search fields</a> here to try a different search with valid characters.</p>\n";
                }
                elseif ($queryData->getQueryString() == "") {
                        // No search element found
                        echo "<h2>Hey, you found our <em>Advanced Search</em>.</h2>\n";
                        echo "<p>It looks like we are still waiting for a query from you.<p>\n";
                        echo "<p><a href=\"#search-form\">Use the search fields</a> here to run a search.</p>\n";
                }
                else {
                        // Valid request
