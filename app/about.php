...
<head>
  ...
  <title>About - MSU Dataset Search, Montana State University (MSU) Library</title>
...
<body>
  ...
  <h1 class="offscreen" property="name">About - Dataset Search, Montana State University (MSU)</h1>
  </header>
  ...
  <main role="main" class="column--two-right">
    <section class="content">
    <h2 id="content">About MSU Dataset Search</h2>
    <div class="loader" hidden>Loading...</div>
    <p>The <strong><span itemprop="publisher">MSU Dataset Search</span></strong> online database has datasets from creators affiliated with Montana State University.</p>
    <p>The MSU Dataset Search database is a product of the <a href="http://www.lib.montana.edu/"><strong><span itemprop="provider">Montana State University (MSU) Library</span></strong></a>.</p>
    <p>Anyone interested in any other use of these materials, including for-profit Internet editions, should obtain permission from the Informatics group at Montana State University Library.</p>
    </section>
    <section class="details" role="complementary">
    <h2 id="details">Contact</h2>
      <dl>
        <dt>Email:</dt>
	<dd><a href="https://ask.lib.montana.edu/">ask.lib.montana.edu</a></dd>
	<dt>Address:</dt>
        <dd>
        <address>
        MSU Library<br/>
