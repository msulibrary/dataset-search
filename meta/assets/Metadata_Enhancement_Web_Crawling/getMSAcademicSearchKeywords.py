...
URI = sys.argv[1] if len(sys.argv) > 1 else 'https://academic.microsoft.com/#/detail/2467059345'
...
def parse_source(uri):
    ...
    skillList = []
    #au-target
    #ma-topic-filter-item-text
    for link in soup.find_all(class_='ma-topic-filter-item-text'):
